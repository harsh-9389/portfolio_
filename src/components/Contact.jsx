  ...
  return (
    ...
    <div name='contact' className='w-full h-screen bg-[#0a192f] flex justify-center items-center p-4'>
        ...
        <div className='flex flex-col max-w-[600px] w-full'>
            ...
            <input className='my-4 p-2 bg-[#ccd6f6] rounded-xl' type="email" placeholder='Email' name='email' />
            <textarea className='bg-[#ccd6f6] p-2 rounded-xl' name="message" rows="10" placeholder='Message'></textarea>
            <button className='text-white border-2 hover:bg-cyan-500 hover:border-cyan-500 px-4 py-3 my-8 mx-auto flex items-center rounded-xl'>Let's Collaborate</button>
        </div>
    </div>
  )
}
